...
func TestListUsers(t *testing.T) {
    ...
    tests := []struct {
    ...
    }{
        {
            ...
            request: baseRequest,
            setupMock: func(mock sqlmock.Sqlmock, req *proto.ListUsersRequest) {
                rows := sqlmock.NewRows([]string{"id", "first_name", "last_name", "user_name", "email", "profile_image_url", "created_at"}).
                    AddRow(1, "Andrei", "Ivancu", "aivancu", "andrei@test.com", "", customTime).
                    AddRow(2, "Ion", "Popescu", "ipopescu", "ion@test.com", "", customTime)

                query := `SELECT id, first_name, last_name, user_name, email, profile_image_url, created_at FROM users ORDER BY id ASC LIMIT $1`
        ...
        },
        {
            ...
            setupMock: func(mock sqlmock.Sqlmock, req *proto.ListUsersRequest) {
                rows := sqlmock.NewRows([]string{"id", "first_name", "last_name", "user_name", "email", "profile_image_url", "created_at"}).
                    AddRow(1, "Andrei", "Ivancu", "aivancu", "andrei@test.com", "", customTime).
                    AddRow(2, "Ion", "Popescu", "ipopescu", "ion@test.com", "", customTime).
                    AddRow(3, "Maria", "Ionescu", "mionescu", "maria@test.com", "", customTime)
        ...
        },
        {
            ...
            setupMock: func(mock sqlmock.Sqlmock, req *proto.ListUsersRequest) {
                rows := sqlmock.NewRows([]string{"id", "first_name", "last_name", "user_name", "email", "profile_image_url", "created_at"}).
                    AddRow(15, "George", "Enescu", "genescu", "george@test.com", "", customTime)

                query := `SELECT id, first_name, last_name, user_name, email, profile_image_url, created_at FROM users WHERE id > $1 ORDER BY id ASC LIMIT $2`
                mock.ExpectQuery(regexp.QuoteMeta(query)).
        ...
        },
        {
            ...
            setupMock: func(mock sqlmock.Sqlmock, req *proto.ListUsersRequest) {
                rows := sqlmock.NewRows([]string{"id", "first_name", "last_name", "user_name", "email", "profile_image_url", "created_at"}).
                    AddRow(1, "Andrei", "Ivancu", "aivancu", "andrei@test.com", "", customTime).
                    AddRow(4, "Andrei", "Tarkovsky", "atarkovsky", "tarkovsky@test.com", "", customTime)

                query := `SELECT id, first_name, last_name, user_name, email, profile_image_url, created_at FROM users WHERE first_name = $1 ORDER BY id ASC LIMIT $2`
                mock.ExpectQuery(regexp.QuoteMeta(query)).
        ...
        },
        {
            ...
            setupMock: func(mock sqlmock.Sqlmock, req *proto.ListUsersRequest) {
                rows := sqlmock.NewRows([]string{"id", "first_name", "last_name", "user_name", "email", "profile_image_url", "created_at"}).
                    AddRow(6, "Andrei", "Popa", "apopa", "apopa@test.com", "", customTime)

                query := `SELECT id, first_name, last_name, user_name, email, profile_image_url, created_at FROM users WHERE first_name = $1 AND id > $2 ORDER BY id ASC LIMIT $3`
                mock.ExpectQuery(regexp.QuoteMeta(query)).
